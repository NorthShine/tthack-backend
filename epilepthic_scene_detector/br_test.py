...
# Вызывать функцию get_epilepthic_risk(chunk)
# Она возвращает среднее значение риска эпилепт-х сцен в чанке
# НЕ ВОЗВРАЩАЕТ ОБРАБОТАННЫЕ ЧАНКИ С КАДРАМИ (над этим я еще работаю)
